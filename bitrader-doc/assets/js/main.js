(function ($) {
  ...
  const swiper = new Swiper(".slideSwipper", {
    // Optional parameters
  ...
  //TODO:: need effect fade run swipper
  const fadeswiper = new Swiper(".fadeSwipper", {
    fadeEffect: {
      crossFade: true
    },
    autoplay: true,
  ...
  // home tree index-multi page swipper
  const multiSwipper = new Swiper(".multiSwipper", {
    direction: "horizontal",
    loop: true,
    autoplay: true,
  });
  ...
  function chartJs() {
    ...
    $("#Tork-chart").each(function () {
      var canvas = $("#Tork-chart");
