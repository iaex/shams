												...
												<ul class="nav nav-pills" id="mainNav">
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li>
																<a class="dropdown-item" href="index.php#demos">
															...
															<li class="dropdown-submenu">
																...
																<ul class="dropdown-menu">
																	...
																	<li><a class="dropdown-item" href="index.php#demos"->More...</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-dark font-weight-bold text-8">Post Left and Right Sidebars</h1>
												...
												<li>
													<div class="comment">
														...
														<div class="comment-block">
															...
															<span class="date float-end">January 12, 2025 at 1:38 pm</span>
														</div>
													</div>
								...
								<li class="d-flex mb-3 pb-1">
									<article class="d-flex">
										...
										<div class="media-body">
											<a href="#">
												<h6 class="text-3 text-color-light opacity-8 line-height-7 ls-0 mb-1">Lorem ipsum dolor sit, consectetur adipiscing elit.</h6>
